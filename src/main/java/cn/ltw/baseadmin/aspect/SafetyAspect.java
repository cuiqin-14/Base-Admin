package cn.ltw.baseadmin.aspect;
...
import cn.ltw.baseadmin.util.AesUtil;
import cn.ltw.baseadmin.util.ErrorUtil;
import cn.ltw.baseadmin.util.RsaUtil;
...
public class SafetyAspect {
     ...
     */
    @Pointcut(value = "execution(public * cn.ltw.baseadmin.sys.*.controller.*.*(..)) || " +
            "execution(public * cn.ltw.baseadmin.*.controller.*.*(..))")
